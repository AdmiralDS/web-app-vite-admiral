const data = [
  ...
  },
  {
    ...
    routes: [
      ...
      { name: 'CardTabMenu. Без обводки', path: '/components/tabMenu/cardTabMenuWithoutBorder' },
  ...
  },
  {
    ...
    routes: [
      ...
      { name: 'С кнопкой "Сегодня"', path: '/components/dateInput/withButton' },
  ...
  },
  {
    ...
    routes: [
      ...
      { name: 'Неконтролируемый сабмит', path: '/components/select/uncontrolledSubmitSearch' },
      { name: 'Multiple с кнопкой "Применить"', path: '/components/select/multiSelectApplyButton' },
      { name: 'Multiple с кнопкой "Выбрать все"', path: '/components/select/multiSelectChooseAll' },
      { name: 'Multiple с увеличенной по умолчанию высотой', path: '/components/select/multiSelectExpandedHeight' },
      { name: 'Multiple с кастомными опциями', path: '/components/select/multiCustomOptionsByRenderChip' },
      {
