...
const ComponentsInputExWithPrefixRoute = ComponentsInputExWithPrefixImport.update({
  id: '/inputEx/withPrefix',
  path: '/inputEx/withPrefix',
  getParentRoute: () => ComponentsRoute,
} as any);

const ComponentsInputExMinMaxvalueRoute = ComponentsInputExMinMaxvalueImport.update({
  id: '/inputEx/minMaxvalue',
  path: '/inputEx/minMaxvalue',
  getParentRoute: () => ComponentsRoute,
} as any);

const ComponentsInputExCurrencyInputFieldRoute = ComponentsInputExCurrencyInputFieldImport.update({
  id: '/inputEx/currencyInputField',
  path: '/inputEx/currencyInputField',
  getParentRoute: () => ComponentsRoute,
} as any);

const ComponentsInputExCurrencyInputRoute = ComponentsInputExCurrencyInputImport.update({
...
const ComponentsRouteChildren: ComponentsRouteChildren = {
  ...
  ComponentsInputExCurrencyInputFieldRoute: ComponentsInputExCurrencyInputFieldRoute,
