...
const Description = () => {
  return (
    <>
    <PStyled>
      Компонент можно разделить на 4 вида: EditMode, EditModeArea, а также компоненты, у которых присутствует лэйбл и дополнительный текст - EditModeField и EditModeAreaField
    </PStyled>
      <PStyled>
