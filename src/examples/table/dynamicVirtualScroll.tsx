...
export const TableDynamicVirtualScroll = () => {
      ...
      text={
        <>
          ...
          <PStyled>
            ...
            свойстве <code>estimatedRowHeight</code> необходимо задать функцию, вычисляющую примерную высоту строки.
            Функция <code>estimatedRowHeight</code> будет использована для оценки высоты строки до момента, когда строка
            будет отрисована и измерена. В качестве входного параметра <code>estimatedRowHeight</code> получает индекс
            строки, который может быть использован для определения примерной высоты строки. Также функция{' '}
