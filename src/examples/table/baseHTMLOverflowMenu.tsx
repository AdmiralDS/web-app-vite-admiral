...
const RowOverflowMenu: React.FC<OverflowMenuProps> = ({ table, renderContent, ...props }) => {
  ...
  return (
    <OverflowMenuWrapper ref={oveflowMenuRef} data-overflowmenu data-opened={false} {...props}>
