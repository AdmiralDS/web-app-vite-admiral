        ...
        text={
          <>
            ...
            <PStyled>
              ...
              параметр virtualScroll={'{{vertical: true}}'}. По умолчанию параметр fixedRowHeight = 40px, для того чтобы
              изменить этот параметр, то необходимо передать в virtualScroll параметр fixedRowHeight с нужным значением.
              Например, для размера таблицы m высота строки по умолчанию составляет 40px (если содержимое ячеек занимает
              одну строку в высоту и для ячеек не было задано каких-то кастомных стилей), для размеров s-32px, l-48px,
              xl-56px.
            </PStyled>
            {
