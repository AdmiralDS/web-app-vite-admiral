...
export const TextAreaVariants = () => {
  return (
    <>
      <ExampleSection text="С отображением иконки очистки.">
        <div style={{ width: '70%' }}>
          <TextField defaultValue="test" label="Лэйбл" extraText="Дополнительный текст" displayClearIcon />
        </div>
      </ExampleSection>
      <ExampleSection text="Опционально можно включать иконку копирования, если возможность копировать текст является важной в вашем сценарии. При этом недоступно удаление текста через иконку очистки «крестик». То есть, либо очистка, либо копирование. Иконка копирования видна только при наличии текста в поле.">
        <div style={{ width: '70%' }}>
          <TextField defaultValue="test" label="Лэйбл" extraText="Дополнительный текст" displayCopyIcon />
        </div>
      </ExampleSection>
      <ExampleSection
        text="Counter. Можно задавать при каком значении от максимума знаков появляется счетчик, по дефолту стоит 80%."
      >
        <div style={{ width: '70%' }}>
      ...
      <ExampleSection
        text="С фиксированной высотой."
      >
        <div style={{ width: '70%' }}>
          <TextField defaultValue="Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text." label="Лэйбл" extraText="Дополнительный текст" maxRows={3} />
        </div>
      </ExampleSection>
      <ExampleSection
        text="Минимальная и максимальная высота."
      >
        <div style={{ width: '70%' }}>
