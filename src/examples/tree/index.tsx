    ...
    <>
      <ExampleSection
        text={
          <>
            <PStyled>
              Компонент используется для отображения дерева вложенных списков с возможностью выбора отдельных пунктов.
              Ширина строки настравивается вручную, по умолчанию это 768px. В настройках присутствует до 6ти уровней
              вложенности.
            </PStyled>
            <PStyled>
              Опционально можно отключить чекбоксы. В таком случае, клик по строке выполняет действие задаваемое
              пользователем.
            </PStyled>
          </>
        }
