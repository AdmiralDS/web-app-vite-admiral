...
const columns = [
  ...
  columnHelper.accessor('age', { header: 'Age', cell: TextCell, meta: { gridColumnTemplate: '90px' } }),
  columnHelper.accessor('bio', { header: 'Bio', cell: TextCell, meta: { gridColumnTemplate: '100px' } }),
] satisfies ColumnDef<StoryItem, never>[];
const data: StoryItem[] = makeItems(makeItem, 30);

export const UserTableWithLongText = () => {
