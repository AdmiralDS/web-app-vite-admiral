...
const columns = [
  columnHelper.accessor('name', { header: 'Name', cell: TextCell, meta: { gridColumnTemplate: '300px' } }),
  columnHelper.accessor('age', { header: 'Age', cell: TextCell, meta: { gridColumnTemplate: '300px' } }),
  columnHelper.accessor('bio', { header: 'Bio', cell: TextCell, meta: { gridColumnTemplate: '300px' } }),
] satisfies ColumnDef<StoryItem, never>[];
const data: StoryItem[] = makeItems(makeItem, 10);

export const UserTableWithHorizontalScroll = () => {
