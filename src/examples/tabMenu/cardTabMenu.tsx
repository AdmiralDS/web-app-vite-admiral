          ...
          <>
            ...
            <PStyled>
              ...
              <UnorderedList dimension="s" style={{ marginTop: '8px' }}>
                <ListItem>При загрузке страницы, одна из вкладок должна быть активной по дефолту</ListItem>
                <ListItem>Текст в закладке должен быть коротким, в идеале не более трех слов</ListItem>
                <ListItem>
                ...
                <ListItem>Избегайте помещения компонента Card Tabs внутрь контента другого Card Tabs</ListItem>
                <ListItem>
