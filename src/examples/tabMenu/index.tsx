          ...
          <>
            ...
            <PStyled>
              ...
              <UnorderedList dimension="s" style={{ marginTop: '8px' }}>
                <ListItem>
                  Одна из вкладок должна быть выбрана по умолчанию, когда пользователь загружает страницу.
                </ListItem>
                <ListItem>
                  Рекомендовано делать надписи на вкладках как можно короче - в идеале не более двух слов.
                </ListItem>
                <ListItem>Не перегружайте пользователя слишком большим количеством вкладок.</ListItem>
                <ListItem>
                  Если пользователь переходит на другую панель вкладок, данные формы не должны автоматически сохраняться
                  или отправляться.
                </ListItem>
                <ListItem>Избегайте вложения Tab Menu в содержимое другого Tab Menu.</ListItem>
                <ListItem>
                  Не заставляйте пользователей переключаться между несколькими вкладками для сравнения информации.
                  Каждая панель вкладок должна содержать всю информацию, необходимую пользователю для выполнения своей
                  задачи.
                </ListItem>
                <ListItem>
                  Не помещайте кнопки или ссылки в заголовок вкладки. Вкладка уже является ссылкой или кнопкой, поэтому
                  у нее не может быть дочернего элемента, который также является ссылкой или кнопкой.
                </ListItem>
              </UnorderedList>
            </PStyled>
          </>
